...
2. **Book Home（书的主页）** —— 先 **Orient yourself**：页面顶部 4 个问题以**纯静态认知提示**展示（没有输入框、不存 DB、不喂 AI）。读完心里过一遍，再到下方问问题。4 个问题是：① What is this book about? ② Who wrote it, and what's their background? ③ Who is it written for? ④ What do you want to take away from it? 下方就是 Ask 区：TOC、overview、3 个 AI 推荐起手问题、自由输入框、本书的历史问题列表。
