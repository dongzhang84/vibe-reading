...
**下一步**：**§12.A UAT solo dogfood** —— 创始人自己用 Vibe Reading 读完一本真想读的书，看哪里卡住、哪里别扭、哪里发现新 bug。这是非编码工作。§12.B Custom Domain 已于 2026-05-02 完成（`vibe-reading.dev`，apex 当主，www 307 到 apex）。下一个编码 milestone 是 §12.C：邀请朋友测前接 Sentry + Posthog。
